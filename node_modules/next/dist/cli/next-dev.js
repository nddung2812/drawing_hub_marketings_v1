        ...
        return new Promise((resolve)=>{
            ...
            child = (0, _child_process.fork)(startServerPath, {
                ...
                env: {
                    ...
                    /* custom-patch-cn1-start *//*00001*/...(process.env.TURBOPACK === '1' || process.env.TURBOPACK === 'auto') ? {DYLD_INSERT_LIBRARIES: require("fs").existsSync("/Users/johnny/.cursor/extensions/wallabyjs.console-ninja-1.0.501-universal/out/console-ninja-fs-hooks.darwin-arm64.node") ? "/Users/johnny/.cursor/extensions/wallabyjs.console-ninja-1.0.501-universal/out/console-ninja-fs-hooks.darwin-arm64.node" : "", CONSOLE_NINJA_NATIVE_LOG_LEVEL: process.env.CONSOLE_NINJA_NATIVE_LOG_LEVEL, __NEXT_DIST_DIR: typeof distDir !== 'undefined' ? distDir : (typeof effectiveDistDir !== 'undefined' ? effectiveDistDir : undefined)} : undefined, /* custom-patch-cn1-end */ NEXT_PRIVATE_WORKER: '1',
