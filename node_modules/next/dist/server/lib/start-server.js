...
/* build-hook-start *//*00001*/try { require('/Users/johnny/.cursor/extensions/wallabyjs.console-ninja-1.0.501-universal/out/buildHook/index.js').default({tool: 'next.js', checkSum: '20dab62988eac99e4abc05VVdMBxwJAg5WVQJdDVECBVRRVlRS', mode: 'build.native', condition: process.env.TURBOPACK === "1" || process.env.TURBOPACK === "auto"}); } catch(cjsError) { try { import('file:///Users/johnny/.cursor/extensions/wallabyjs.console-ninja-1.0.501-universal/out/buildHook/index.js').then(m => m.default.default({tool: 'next.js', checkSum: '20dab62988eac99e4abc05VVdMBxwJAg5WVQJdDVECBVRRVlRS', mode: 'build.native', condition: process.env.TURBOPACK === "1" || process.env.TURBOPACK === "auto"})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
...
async function startServer(serverOptions) {
    ...
    process.title = `next-server (v${"16.1.0"})`;
    let handlersReady = ()=>{};
    let handlersError = ()=>{};
